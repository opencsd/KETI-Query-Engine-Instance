...
ORDER  BY l_returnflag,\n\
        ...
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_02"){ //TPC-H Query 2
...
limit 100;");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_03"){ //TPC-H Query 3
            parsed_query.SetParsedQuery("SELECT   l_orderkey, \n\
...
LIMIT    10;");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_04"){ //TPC-H Query 4
            parsed_query.SetParsedQuery("select \n\
...
order by \n\
    o_orderpriority;");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_05"){ //TPC-H Query 5
            parsed_query.SetParsedQuery("select \n\
    n_name, \n\
    sum(l_extendedprice * (1 - l_discount)) as revenue \n\
from \n\
...
where\n\
	...
	and l_quantity < 24;");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_07"){ //TPC-H Query 7
            parsed_query.SetParsedQuery("select \n\
    supp_nation, \n\
    cust_nation, \n\
    l_year, \n\
...
order by \n\
    ...
    l_year;");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_08"){ //TPC-H Query 8
            parsed_query.SetParsedQuery("select \n\
    o_year, \n\
...
order by \n\
    o_year;");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_09"){ //TPC-H Query 9
            parsed_query.SetParsedQuery("select \n\
    nation, \n\
    o_year, \n\
...
order by \n\
    ...
    o_year desc;");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_10"){ //TPC-H Query 10
            parsed_query.SetParsedQuery("select c_custkey,\n\
	c_name,\n\
	sum(l_extendedprice * (1 - l_discount)) as revenue,\n\
	c_acctbal,\n\
	n_name,\n\
...
limit 20;");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_11"){ //TPC-H Query 11
            parsed_query.SetParsedQuery("SELECT ps_partkey,\n\
...
ORDER  BY value DESC;");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_12"){ //TPC-H Query 12
            parsed_query.SetParsedQuery("SELECT l_shipmode,\n\
       SUM(CASE\n\
...
ORDER  BY l_shipmode; ");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_13"){ //TPC-H Query 13
            parsed_query.SetParsedQuery("SELECT c_count,\n\
       Count(*) AS custdist\n\
...
ORDER  BY custdist DESC,\n\
          c_count DESC; ");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_14"){ //TPC-H Query 14
            parsed_query.SetParsedQuery("SELECT 100.00 * SUM(CASE\n\
...
ORDER  BY supplier_cnt DESC,\n\
          ...
          p_size;");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_17"){ //TPC-H Query 17            
            parsed_query.SetParsedQuery("SELECT SUM(l_extendedprice) / 7.0 AS avg_yearly \n\
FROM   lineitem, \n\
       part \n\
WHERE  p_partkey = l_partkey \n\
       ...
       AND l_quantity < (SELECT 0.2 * AVG(l_quantity) \n\
                         ...
                         WHERE  l_partkey = p_partkey);");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_18"){ //TPC-H Query 18
            parsed_query.SetParsedQuery("SELECT c_name,\n\
       c_custkey,\n\
       o_orderkey,\n\
       o_orderdate,\n\
       o_totalprice,\n\
...
LIMIT  100; ");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_19"){ //TPC-H Query 19
            parsed_query.SetParsedQuery("SELECT Sum(l_extendedprice * ( 1 - l_discount )) AS revenue\n\
FROM   lineitem,\n\
       part\n\
WHERE  ( p_partkey = l_partkey\n\
        ...
        OR ( p_partkey = l_partkey\n\
             ...
             AND l_shipinstruct = 'deliver in person' );");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_20"){ //TPC-H Query 20
            parsed_query.SetParsedQuery("SELECT s_name,\n\
       s_address\n\
FROM   supplier,\n\
       nation\n\
...
ORDER  BY s_name; ");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_21"){ //TPC-H Query 21
            parsed_query.SetParsedQuery("SELECT s_name,\n\
       Count(*) AS numwait\n\
FROM   supplier,\n\
       lineitem l1,\n\
...
LIMIT  100; ");
          parsed_query.SetQueryTypeAsOffloading();
        } else if(parsed_query.GetOriginalQuery() == "TPC-H_22"){ //TPC-H Query 22
            parsed_query.SetParsedQuery("SELECT cntrycode,\n\
       Count(*)       AS numcust,\n\
